...
/* Attribute and other constants related to security domain */
...
/* Attribute and other constants related to ceritificate category */
...
typedef unsigned long int CK_JAVA_MIDP_SECURITY_DOMAIN;
